...
div
  ...
  div.d-flex.mt-1
    span.mr-auto.small.text-muted {{ $t('search.hostname', { hostname: queryOptions.hostname }) }}
  ...
  div(v-if="events != null")
    ...
    div
      | {{ $t('search.notFound') }}
      br
      | {{ $t('search.addWeek') }} #[b-button(size="sm" variant="outline-dark" @click="extendByWeek()") {{ $t('search.addWeekButton') }}]
</template>
