export default {
  ...
  timeline: {
    ...
    filters: {
      ...
      minimumDurationUnit: 'Einheit der Mindestdauer',
      maximumDurationUnit: 'Einheit der Höchstdauer',
      seconds: 'Sekunden',
      minutes: 'Minuten',
      hours: 'Stunden',
      durationNonNegativeError: 'Dauerwerte dürfen nicht negativ sein.',
      durationError: 'Die Mindestdauer darf die Höchstdauer nicht überschreiten.',
      hostCount: '{count} Host | {count} Hosts',
      clientCount: '{count} Client | {count} Clients',
      categoryCount: '{count} Kategorie | {count} Kategorien',
      afkSummary: 'AFK gefiltert',
      mergeSummary: 'nach App zusammengeführt',
      none: 'keine',
      durationRange: '{min} bis {max}',
      durationAtLeast: 'Mindestens {value}',
      durationAtMost: 'Höchstens {value}',
    },
  },
  stopwatch: {
    title: 'Stoppuhr',
