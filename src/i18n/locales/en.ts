export default {
  ...
  timeline: {
    ...
    filters: {
      ...
      minimumDurationUnit: 'Minimum duration unit',
      maximumDurationUnit: 'Maximum duration unit',
      seconds: 'seconds',
      minutes: 'minutes',
      hours: 'hours',
      ...
      afkSummary: 'AFK filtered',
      mergeSummary: 'merged by app',
      none: 'none',
      durationRange: '{min} – {max}',
      durationAtLeast: 'At least {value}',
      durationAtMost: 'At most {value}',
    },
  },
  stopwatch: {
    title: 'Stopwatch',
